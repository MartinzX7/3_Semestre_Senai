...
router.post('/usuarios', async (req, res) => {
    ...
    try {
        ...
        const comando = `INSERT INTO USUARIOS(nome, email, senha, tipo_acesso, ativo) VALUES($1, $2, $3, $4, $5)`
...
router.put('/usuarios/:id_usuario', async (req, res) => {
    ...
    try {
        ...
        ativo = true, id_usuario = $6`;
        const valores = [nome, email, senha, tipo_acesso, ativo, id_usuario];
        await BD.query(comando, valores);
...
router.update('/usuarios/:id_usuario', async (req, res) => {
    const { id_usuario, ativo } = req.params;
    try {
        //Executa o comando de update
        const comando = `UPDATE FROM USUARIOS WHERE id_usuario = $1`
